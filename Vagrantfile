...
Vagrant.configure(2) do |config|
  ...
  config.vm.define "sonarqube" do |d|
    d.vm.box = "ubuntu/trusty64"
    d.vm.hostname = "sonarqube"
    d.vm.network "private_network", ip: "10.100.98.200"
#    d.vm.network "public_network", bridge: "eno4", ip: "192.168.57.38", auto_config: "false", netmask: "255.255.255.0" , gateway: "192.168.57.1"
